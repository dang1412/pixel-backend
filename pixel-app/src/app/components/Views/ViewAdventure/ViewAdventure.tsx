...
import { buildingImages, itemImages } from '@/libs/viewport/adventure/constants'
...
export const ViewAdventure: React.FC<Props> = (props) => {
  ...
  return (
    <div>
      ...
      <br/>
      {buildingIds.map((id, ind) => <img className='inline-block mr-2' key={ind} id={`building-${ind}`} src={buildingImages[id]} onDragStart={(e) => dragBuilding(e, id)} width="120" height="120" />)}
              ...
              <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      {itemIds.map((id, ind) => <img className='inline-block mr-2' key={ind} id={`item-${ind}`} src={itemImages[id]} width="60" height="60" />)}
                    </div>
                  </div>
                </div>
              </div>
