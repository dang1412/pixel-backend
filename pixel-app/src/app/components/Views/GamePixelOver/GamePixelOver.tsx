...
import { PixelGameMap, PixelMap } from '@/libs/viewport'
...
const _GamePixelOver: React.FC<PixelOverProps> = ({x, y, game}) => {
...
export const GamePixelOver = React.memo(_GamePixelOver)